...
function  WWHControlEntry_GetHTML()
{
  ...
  var  VarLabel;
   ...
   // document.write("<script type=\'text/javascript\' src=\'guidewire-linktothis.js\'></script>");
  ...
  if (this.mbEnabled)
  {
    ...
    var controlWidthOverride = 23;

    if ((this.fGetIconURL().search("bkmark.gif") != -1) || (this.fGetIconURL().search("bkmarkx.gif") != -1)) {
       controlWidthOverride = 102;
    }
    else if ((this.fGetIconURL().search("prev.gif") != -1) || (this.fGetIconURL().search("prevx.gif") != -1))  {
       controlWidthOverride = 104;
    }
    else if ((this.fGetIconURL().search("next.gif") != -1) || (this.fGetIconURL().search("nextx.gif") != -1))  {
       controlWidthOverride = 81;
    }
    else if ((this.fGetIconURL().search("sync.gif") != -1) || (this.fGetIconURL().search("syncx.gif") != -1))  {
       controlWidthOverride = 89;
    }
    else if ((this.fGetIconURL().search("shownav.gif") != -1) || (this.fGetIconURL().search("shownavx.gif") != -1))  {
       controlWidthOverride = 89;
    }
    ...
    // Display control
    //
    VarHTML += "  <td width=\""+controlWidthOverride+"\">";
    VarHTML += "<div>";
    VarHTML += "<a name=\"" + this.mControlName + "\" href=\"javascript:WWHFrame.WWHControls." + this.mAnchorMethod + "();\" title=\"" + VarLabel + "\">";
    VarHTML += "<img name=\"" + this.mControlName + "\" alt=\"" + VarLabel + "\" border=\"0\" src=\"" + this.fGetIconURL() + "\" width=\""+controlWidthOverride +"\" height=\"21\">";
    VarHTML += "</a>";
...
function  WWHControls_Bookmark()
{
  ...
  if (this.fCanSyncTOC())
  {
    ...
    // for simple reload-the-URL version of the button...
    //window.location = WWHFrame.WWHHelp.mHelpURLPrefix + "wwhelp/wwhimpl/api.htm?href=" + WWHFrame.WWHBrowser.fRestoreEscapedSpaces(WWHFrame.WWHHelp.fGetBookFileHREF(this.mSyncPrevNext[0]));
...
function  WWHControls_BookmarkData()
{
  ...
  if (this.fCanSyncTOC())
  {
    ...
    if (DocumentURL != null)
    {
     ...
     // TEMPORARILY THIS LINE IS NOT USED!! The wacky javascript line seems unnecessary
     // DocumentBookmarkURL2 = "javascript:x=unescape('" + escape(DocumentBookmarkURL) + "');if(typeof(window.WWHFrame)!='undefined'){window.WWHFrame.WWHHelp.fSetContextDocument(x);}else{" + ResetEverything + ";}";
