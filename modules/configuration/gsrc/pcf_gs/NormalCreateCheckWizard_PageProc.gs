...
class NormalCreateCheckWizard_PageProc {

  private var wiz : gw.api.financials.NormalCreateCheckWizardInfo
  
  construct(theWiz : gw.api.financials.NormalCreateCheckWizardInfo) {
    wiz = theWiz
  }
