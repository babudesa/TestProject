<%@ params(investigation : SIUInvestigationExt, partiesChanged : Boolean, partiesAddedRemoved : Boolean) %>
<html>
	<head>
		<style type="text/css">
	...
	<body> 
		...
		<table>
				<tr>
					<td class=header>Data Research Request</td>
				</tr>
				<tr>
					<td><br></td>
				</tr>
				  ...
				  <td>
					<table>
						...
						<tr>
							...
							<td class=value><%= investigation.SIUClaimType.DisplayName %></td>
						</tr>
						...
						<table>
              					...
              					<%  var bodyStr = new java.lang.StringBuilder()
              						...
              						bodyStr.append("<tr><th class=\"label\">Person of Company Information:</th>")
                                                        ...
                                                        //bodyStr.append("<th class=\"label\">Analyst Servies:</th>")
                                                        bodyStr.append("<th class=\"label\">Services Requested:</th>")
        
                                                        for (each in investigation.DataResearchParties) {
                                                          var dataCon = each.Contact
                                                          bodyStr.append("<tr>")
                                                            bodyStr.append("<td class=\"value\">" 
                                                            + investigation.siuContactInfo(dataCon) +"</td>")
                                                            bodyStr.append("<td class=\"value\">" + investigation.siuContactRoles(dataCon) +"</td>")
