	...
	<body> 
		...
		<table>
			<%if (c.Closed) {%>
				...
				<tr>
					<td class=value><p>The following claim has been closed:</p></td>
				</tr>
				<tr>
					<td><br></td>
				</tr>				
			<%} else {%>
				<tr>
					<td class=header>Notice of Reopened Claim</td>
				</tr>
				<tr>
					<td><br></td>
				</tr>
				...
				<tr>
					<td class=value><p>The following claim has been reopened:</p></td>
				</tr>
				<tr>
					<td><br></td>
				</tr>
				...
				<td>		 
					<table>
						...
						<tr>
							...
							<td class=value><%= c.DeathDate==null ? "": gw.api.util.StringUtil.formatDate( death, "MM-dd-yyyy" ) %></td>
						</tr>	
					    <% if(c.Closed){ %>
					    <tr>
							<td class=label>Close Reason:</td>
							<td class=value><%= c.ClosedOutcome.DisplayName %></td>
							<% } else{ %>
						<tr>	
							<td class=label>Reopen Reason:</td>
							<td class=value><%= c.ReopenedReason.DisplayName %></td>
							<%}%>
					    </tr>
						</tr>
