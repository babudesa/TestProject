...
<%@ params(theclaim : Claim, thepolicy : Policy, therisk : LocationBasedRU, theexposure : Exposure, objStatus : String, riskCat : String, cvrg : String, riskType : String, eventName : String, actualbuilding : String, thebuildingnumber : String, actualpremises : String, thepremisesnumber : String) %>
<Risk>
  ...
  <%}%>
  <% if (thebuildingnumber == null) {%>
  <RelToRisk><%=actualbuilding%>.BLDG</RelToRisk>
  <%} else if (thepremisesnumber == null){%>
        <RelToRisk><%=actualpremises%>.<%=thebuildingnumber%>.BLDG</RelToRisk>
    <%} else {%>
        <RelToRisk><%=thepolicy.PublicID%>.<%=thepremisesnumber%>.<%=thebuildingnumber%>.BLDG</RelToRisk>
  <%}%>
</Risk>