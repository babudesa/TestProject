...
<%@ params(theContact : Contact, additionalInfo : String, objStatus : String, role : String, assignmentStatus : String, partyRelTo : String, roleobjstatus : String, theClaim : Claim) %>
<Party>
  ...
  <% if (theContact typeis Person) {%>
  <%=PersonTemplate.renderToString(theContact, theClaim, null, "", objStatus)%>
  <%}%>
