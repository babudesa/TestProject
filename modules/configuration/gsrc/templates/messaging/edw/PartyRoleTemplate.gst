...
<%@ params(theContact : Contact, additionalInfo : String, role : String, assignmentStatus : String, objStatus : String, partyRelTo : String, roleobjstatus : String) %>
<Party>
  ...
  <% if ((theContact typeis CompanyVendor != null || theContact typeis PersonVendor || theContact typeis NonVendorPayeeCompanyExt || theContact typeis NonVendorPayeePersonExt)
  && theContact.AddressBookUID != null) { %>
 ...
 <%
  ...
  <%-- Defect 6193: no longer create Guardian here --%>
