...
class PLDClaimsCorrections extends BatchProcessBase {
  ...
  construct() {
    super(BatchProcessType.TC_PLDCLAIMSRPTGCORRECTIONS)
 ...
 Override function doWork(): void {
  ...
  public function PLDClaimsDataExtract(): void{
     ...
     var date = new Date()
     var excelSumFileName = "PLDClaimsSummary" + String.valueOf(year) + monthStr + dayStr + ".txt"
     var excelTranFileName = "PLDClaimsTrans"  + String.valueOf(year) + monthStr + dayStr + ".txt"
     var excelBalFileName = "PLDClaimsBalancing" + String.valueOf(year) + monthStr + dayStr + ".txt"
     ...
     var sumFileNameFull = excelSumFileNameIncPath + String.valueOf(year) + monthStr + dayStr + "Fix.txt"

     var tranFileNameFull = excelTranFileNameIncPath + String.valueOf(year) + monthStr + dayStr + "Fix.txt"
     
     var balFileNameFull = excelBalFileNameIncPath + String.valueOf(year) + monthStr + dayStr + "Fix.txt"
