...
enum ISOClaimsPartyRole {
  ...
  OC("OC", "Other Claimant"),
  OP("OP", "Other Professional"),
  OTR("OR", "Other Representative"),
  OS("OS", "Osteopath"),
  PA("PA", "Public Adjuster"),
  PH("PH", "Pharmacy"),
  PS("PS", "Psychologist"),
  PW("PW", "Power Of Attorney"),
  ...
  final static var INDIVIDUAL_ROLES = new ISOClaimsPartyRole[] {
     CL, CI, CD, CP, CE, ID, IP, IE, INS, OW, PT, TN, WT, SalvageBuyer
  }.toSet()
  ...
  static function byCode(aCode : String) : ISOClaimsPartyRole {
    return ROLES_BY_CODE[aCode]
  }
