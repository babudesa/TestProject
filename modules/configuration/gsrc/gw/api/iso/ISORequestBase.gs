...
class ISORequestBase {
  ...
  protected function createClaimsServiceRequest(acord : xsd.iso.req.ACORD) : ClaimInvestigationAddRq {
    ...
    var ClaimSvcrqmsgs = new xsd.iso.req.ClaimsSvcRq_CLAIMSSVCRQMSGS()
  ...
  protected function createSignOnRequest(acord : xsd.iso.req.ACORD) {
    ...
    acord.ACORDREQ.SignonRq.Choice.SignonPswd.CustId.CustPermId = Properties.CustomerLoginId
    acord.ACORDREQ.SignonRq.Choice.SignonPswd.CustId.CustLoginId = Properties.CustomerLoginId
