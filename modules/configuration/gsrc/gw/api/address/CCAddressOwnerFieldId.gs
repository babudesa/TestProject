...
class CCAddressOwnerFieldId extends AddressOwnerFieldId {
  ...
  /**
   * Claim specific field - latitude
   */
  public static final var LATITUDE : AddressOwnerFieldId = new AddressOwnerFieldId("LATITUDE")

  /**
   * Claim specific field - longtitude
   */
  public static final var LONGTITUDE : AddressOwnerFieldId = new AddressOwnerFieldId("LONGTITUDE")
  ...
  public static final var US_REQUIREDFIELDS : Set<AddressOwnerFieldId>
          = {ADDRESS_NAME, COUNTRY, ADDRESSTYPE, ADDRESSLINE1, CITY, STATE, POSTALCODE}.freeze()
  
  public static final var CA_REQUIREDFIELDS : Set<AddressOwnerFieldId>
          ={ADDRESS_NAME, COUNTRY, ADDRESSTYPE, ADDRESSLINE1, CITY, STATE, POSTALCODE}.freeze()
          
  public static final var DEFAULT_REQUIREDFIELDS : Set<AddressOwnerFieldId>
          = {ADDRESS_NAME, COUNTRY, ADDRESSTYPE, ADDRESSLINE1, CITY}.freeze()
          
  /** Commonly used set of hidden fields - just valid until and address type hidden */
  public static final var INJURED_ANIMAL_HIDDEN : Set<AddressOwnerFieldId>
          = {VALIDUNTIL, ADDRESSTYPE, LATITUDE, LONGTITUDE}.freeze()
  ...
  /* Adding Country for visibility to UI as per defect 5531   --tray2 */
  /* Removing Country for visibility to UI as per update to defect 5531   --tray2 */
  public static final var CA_POLICYSEARCH_HIDDENFIELDS : Set<AddressOwnerFieldId>
          ={COUNTRY, LATITUDE, LONGTITUDE}.freeze()           
