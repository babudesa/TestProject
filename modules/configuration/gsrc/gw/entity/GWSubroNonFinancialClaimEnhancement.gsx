...
enhancement GWSubroNonFinancialClaimEnhancement : entity.Claim
{
  ...
  function getPartiesInMatters() : String {
    // gw.api.util.Logger.logInfo( "Log Rule displaykey.DisplayName" + displaykey.Java.DisplayName.NewlyCreated)
  ...
  function getAllAdversePartyRoles() :ClaimContactRole[] {
    ...
    //  gw.api.util.Logger.logInfo( "Log Rule Info sRule")
    ...
    //  gw.api.util.Logger.logInfo( "ClaimAdverseRoles.Length" + numberOfAdverseRole)
