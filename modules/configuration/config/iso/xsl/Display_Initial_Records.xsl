	...
	<xsl:template name="Display_General_Info">
		...
		<xsl:if test="count($TINNum) &gt; 0">
			<tr>
				<td align="left">&#xA0;&#xA0;
					<b>
						<font size="2" face="Arial">TIN:</font>
					</b>
				</td>
				<td align="left">
		...
		<xsl:if test="count($IncepDt) &gt; 0">
			...
			<tr>
				<td align="left">&#xA0;&#xA0;
					<b>
						<font size="2" face="Arial">Inception Date:</font>
					</b>
				</td>
				<td align="left">
					<font size="2" face="Arial">
		...
		<xsl:if test="count($isoReceiveDt) &gt; 0">
			<xsl:call-template name="Insert_Data">
				...
				<xsl:with-param name="Data_Value">
					...
					<xsl:number value="substring($isoReceiveDt,1,4)" format="0001"/>&#xA0;</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
		<xsl:call-template name="Insert_Data">
		...
		<xsl:if test="count(ClaimsParty[ClaimsPartyInfo/ClaimsPartyRoleCd = 'Emergency']/GeneralPartyInfo/NameInfo/CommlName/CommercialName) &gt;0">
			<tr>
				<td align="left">&#xA0;&#xA0;
					<b>
						<font size="2" face="Arial">Agency Notified:</font>
					</b>
				</td>
				<td align="left">
					<font size="2" face="Arial">
					...
					<xsl:if test="count(ClaimsOccurrence/ClaimsReported[@ReportedToRef = $PFReported2Ref]/ReportNumber) &gt;0">
						<b>
							<font size="2" face="Arial">&#xA0;&#xA0;&#xA0;&#xA0;Report Case No.:</font>
						</b>
						<font size="2" face="Arial">
							<xsl:value-of select="ClaimsOccurrence/ClaimsReported[@ReportedToRef = $PFReported2Ref]/ReportNumber"/>
						</font>
		...
		<xsl:if test="count($CAT) &gt;0">
			<tr>
				<td align="left">&#xA0;&#xA0;
					<b>
						<font size="2" face="Arial">CAT Related?:</font>
					</b>
				</td>
				<td align="left">
					<font size="2" face="Arial">
					...
					<xsl:if test="count(ClaimsOccurrence/Catastrophe/CatastropheCd) &gt; 0">
						<b>
							<font size="2" face="Arial">&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;CAT Number:</font>
						</b>
						<font size="2" face="Arial">
							<xsl:value-of select="ClaimsOccurrence/Catastrophe/CatastropheCd"/>
						</font>
			...
			<tr>
				<td align="left" colspan="4">
					<xsl:if test="Policy/MiscParty/com.iso_SIUInfo/com.iso_InsurerFraudRingInvestigation = 'Y'">
						<font size="2" face="Arial">&#xA0;&#xA0;<xsl:value-of select="'&gt; CLAIM ASSOCIATED WITH INSURER FRAUD RING INVESTIGATION'"/></font>
					</xsl:if>
				</td>
			</tr>
		</xsl:if>
		...
		<xsl:if test="count(Policy/MiscParty/com.iso_SIUInfo/com.iso_SurName) &gt;0">
			<xsl:call-template name="Insert_Data">
				...
				<xsl:with-param name="Data_Value">
					...
					<xsl:if test="string-length(Policy/MiscParty/com.iso_SIUInfo/com.iso_OtherGivenName) != 0 ">&#xA0;<xsl:value-of select="Policy/MiscParty/com.iso_SIUInfo/com.iso_OtherGivenName"/></xsl:if>
					<xsl:if test="string-length(Policy/MiscParty/com.iso_SIUInfo/com.iso_SurName) != 0 ">&#xA0;<xsl:value-of select="Policy/MiscParty/com.iso_SIUInfo/com.iso_SurName"/></xsl:if>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
				...
				<td>
					<xsl:choose>
						<xsl:when test="string-length(GeneralPartyInfo/NameInfo/PersonName) != 0">
							<xsl:call-template name="Insert_Sum_Data">
								<xsl:with-param name="Data_Value">
									...
									<xsl:if test="string-length(GeneralPartyInfo/NameInfo/PersonName/OtherGivenName) != 0 ">&#xA0;<xsl:value-of select="GeneralPartyInfo/NameInfo/PersonName/OtherGivenName"/></xsl:if>
									<xsl:if test="string-length(GeneralPartyInfo/NameInfo/PersonName/Surname) != 0 ">&#xA0;<xsl:value-of select="GeneralPartyInfo/NameInfo/PersonName/Surname"/>,&#xA0;&#xA0;</xsl:if>
								</xsl:with-param>
								<xsl:with-param name="Data_Code_Value">
						...
						<xsl:otherwise>
							<xsl:call-template name="Insert_Sum_Data">
								<xsl:with-param name="Data_Value">
									<xsl:value-of select="GeneralPartyInfo/NameInfo/CommlName/CommercialName"/>,&#xA0;&#xA0;</xsl:with-param>
								<xsl:with-param name="Data_Code_Value">
									<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/MiscPartyRoleCds/*[@code=$ClaimsPartyRoleCd]"/>
								</xsl:with-param>
							</xsl:call-template>
					...
					<table border="0" width="650" cellpadding="0" cellspacing="0">
						...
						<xsl:if test="count(../AdjusterParty/AdjusterPartyInfo[@AssignmentRef = $MC01Id1]) &gt; 0">
							<xsl:for-each select="../AdjusterParty/AdjusterPartyInfo[@AssignmentRef = $MC01Id1]">
								<xsl:variable name="CoverageCMS" select="@AssignmentRef"/>
								...
								<xsl:if test="count($casCMS[@itemRef=$CoverageCMS]) &gt; 0">
									<tr>
										<td colspan="4" valign="top">
											<font face="arial" size="2" color="red">
												<b>Missing CMS Required Field:</b>
									...
									<tr>
										<td colspan="4">
											<font face="arial" size="2">
												<!--<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/COVERAGE-TYPES/*[@code=$CoverageCode]"/>-->
												<xsl:for-each select="$casCMS[@itemRef=$CoverageCMS]">  <!-- Defect 7978, duplicate CMS warnings eliminated -->
													<xsl:for-each select="com.iso_CMSWarning">          <!-- Defect 7978, duplicate CMS warnings eliminated -->
													<!--<xsl:value-of select="."/>-->
													<xsl:variable name="CMSWarning" select="."/>
													<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/CMSWarningCds/*[@code=$CMSWarning]"/>
													<!--<xsl:value-of select="position()!=last()">-->
						...
						<xsl:if test="count(../AdjusterParty/AdjusterPartyInfo[@AssignmentRef = $WaterCraftId][$PropLossNode = $MO01Id1]) &gt; 0">
							<tr>
								<td width="100" nowrap="nowrap">
									<font face="arial" size="2">
										<b>Coverage:</b>
								...
								<td width="250" align="left" nowrap="nowrap">
									<font face="arial" size="2">
										<xsl:if test="../AdjusterParty/AdjusterPartyInfo[@AssignmentRef = $WaterCraftId][$PropLossNode = $MO01Id1]">
											<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/COVERAGE-TYPES/*[@code=$WaterCraftCoverage]"/>
										</xsl:if>
									</font>
								</td>
								<td width="100" nowrap="nowrap">
								...
								<td align="left" nowrap="nowrap">
									<font face="arial" size="2">
										<xsl:if test="../AdjusterParty/AdjusterPartyInfo[@AssignmentRef = $WaterCraftId][$PropLossNode = $MO01Id1]">
											...
											<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/LOSS-TYPES/*[@code=$WaterCraftLoss]"/>
										</xsl:if>
									</font>
								</td>
							</tr>
						...
						<xsl:if test="count(../AdjusterParty/AdjusterPartyInfo[@AssignmentRef = $MPId][$PropLossNode = $MO01Id1]) &gt; 0">
							<tr>
								...
								<td width="250" align="left" nowrap="nowrap">
									<font face="arial" size="2">PROPERTY
										<!--
					...
					<td>
						<table width="650" border="1" cellpadding="3" cellspacing="0" style="border: 1px solid #d0d0d0;">
							...
							-->
								...
								<th></th>
								<th>
									<font size="2" face="Arial">Same Loss Type</font>
								</th>
								<th>
									<font size="2" face="Arial">SIU Involve<br/>-ment</font>
								</th>
								<th>
									<font size="2" face="Arial">Name</font>
								</th>
								<th>
									<font size="2" face="Arial">Address</font>
								</th>
								<th>
									<font size="2" face="Arial">SSN</font>
								</th>
								<th>
									<font size="2" face="Arial">Phone</font>
								</th>
								<th>
									<font size="2" face="Arial">Driver's License</font>
								</th>
								<th>
									<font size="2" face="Arial">VIN</font>
								</th>
								<th>
									<font size="2" face="Arial">License Plate</font>
								</th>
								<th>
									<font size="2" face="Arial">Key indicators<br/>for this party</font>
								</th>
							</tr>
							<tr>
								...
								<td width="32" class="cell_border" align="center">
									...
									<xsl:choose>
										<xsl:when test="$SIULossType &gt; 0">&#xA0;<font face="arial" size="2">
												<!--<xsl:value-of select="$SIULossType "/>-->
												<xsl:number value="$SIULossType" format="1"/></font></xsl:when>
								...
								<td width="32" class="cell_border" align="center">
									...
									<xsl:choose>
										<xsl:when test="$SIUInvolvement &gt; 0">&#xA0;<font face="arial" size="2">
												<!--<xsl:value-of select="$SIUInvolvement"/>-->
												<xsl:number value="$SIUInvolvement" format="1"/></font></xsl:when>
										<xsl:otherwise>&#xA0;</xsl:otherwise>
									</xsl:choose>
								</td>
								<td width="32" class="cell_border" align="center">
									...
									<xsl:choose>
										<xsl:when test="$SIUTotalName &gt; 0">&#xA0;<font face="arial" size="2">
												<!--<xsl:value-of select="$SIUTotalName"/>-->
												<xsl:number value="$SIUTotalName" format="1"/></font></xsl:when>
										<xsl:otherwise>&#xA0;</xsl:otherwise>
									</xsl:choose>
								</td>
								<td width="32" class="cell_border" align="center">
									...
									<xsl:choose>
										<xsl:when test="$SIUTotalAddr &gt; 0">&#xA0;<font face="arial" size="2">
												<!--<xsl:value-of select="$SIUTotalAddr"/>-->
												<xsl:number value="$SIUTotalAddr" format="1"/></font></xsl:when>
										<xsl:otherwise>&#xA0;</xsl:otherwise>
									</xsl:choose>
								</td>
								<td width="32" class="cell_border" align="center">
									...
									<xsl:choose>
										<xsl:when test="$SIUTotalSSN &gt; 0">&#xA0;<font face="arial" size="2">
												<!--<xsl:value-of select="$SIUTotalSSN"/>-->
												<xsl:number value="$SIUTotalSSN" format="1"/></font></xsl:when>
										<xsl:otherwise>&#xA0;</xsl:otherwise>
									</xsl:choose>
								</td>
								<td width="32" class="cell_border" align="center">
									...
									<xsl:choose>
										<xsl:when test="$SIUTotalPhone &gt; 0">&#xA0;<font face="arial" size="2">
												<!--<xsl:value-of select="$SIUTotalPhone"/>-->
												<xsl:number value="$SIUTotalPhone" format="1"/></font></xsl:when>
										<xsl:otherwise>&#xA0;</xsl:otherwise>
									</xsl:choose>
								</td>
								<td width="32" class="cell_border" align="center">
									...
									<xsl:choose>
										<xsl:when test="$SIUTotalDrivLic &gt; 0">&#xA0;<font face="arial" size="2">
												<!--<xsl:value-of select="$SIUTotalDrivLic"/>-->
												<xsl:number value="$SIUTotalDrivLic" format="1"/></font></xsl:when>
										<xsl:otherwise>&#xA0;</xsl:otherwise>
									</xsl:choose>
								</td>
								<td width="32" class="cell_border" align="center">
									...
									<xsl:choose>
										<xsl:when test="$SIUTotalVIN &gt; 0">&#xA0;<font face="arial" size="2">
												<!--<xsl:value-of select="$SIUTotalVIN"/>-->
												<xsl:number value="$SIUTotalVIN" format="1"/></font></xsl:when>
										<xsl:otherwise>&#xA0;</xsl:otherwise>
									</xsl:choose>
								</td>
								<td width="32" class="cell_border" align="center">
									...
									<xsl:choose>
										<xsl:when test="$SIUTotalLicPlate &gt; 0">&#xA0;<font face="arial" size="2">
												<!--<xsl:value-of select="$SIUTotalLicPlate"/>-->
												<xsl:number value="$SIUTotalLicPlate" format="1"/></font></xsl:when>
										<xsl:otherwise>&#xA0;</xsl:otherwise>
									</xsl:choose>
								</td>
								<!--key ind-->
								<td width="222" valign="top" rowclass="cell_border" align="left" rowspan="30">
									...
									<xsl:if test="$ipKeyInd = 02">
										<li>
											<font face="arial" size="2">
												<xsl:value-of select="'Professional Discipline or Sanctions (AMA, etc)'"/>
											</font>
										</li>
										<br/>
									</xsl:if>
									...
									<xsl:if test="$ipKeyInd = 04">
										<li>
											<font face="arial" size="2">
												<xsl:value-of select="'30-day Pre/Post Policy Inception or Cancellation'"/>
											</font>
										</li>
										<br/>
									</xsl:if>
									...
									<xsl:if test="$ipKeyInd = 10">
										<li>
											<font face="arial" size="2">
												<xsl:value-of select="'Undocumented loss (no police or incident reports)'"/>
											</font>
										</li>
										<br/>
									</xsl:if>
									<xsl:if test="$ipKeyInd = 11">
										<li>
											<font face="arial" size="2">
												<xsl:value-of select="'Date of hire or termination to date of loss (WC)'"/>
											</font>
										</li>
										<br/>
									</xsl:if>
							...
							<xsl:for-each select="../MatchDetails/com.iso_SumReasonInfo[@ClaimsPartyRef = $MO01Id1]">
								<tr>
									...
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumCode = 'LT'">&#xA0;<font size="2" face="Arial">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumCode = 'SI'">&#xA0;<font size="2" face="Arial">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumCode = 'N'">&#xA0;<font size="2" face="Arial">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumCode = 'A'">&#xA0;<font size="2" face="Arial">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumCode = 'S'">&#xA0;<font size="2" face="Arial">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumCode = 'P'">&#xA0;<font size="2" face="Arial">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumCode = 'D'">&#xA0;<font size="2" face="Arial">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumCode = 'V'">&#xA0;<font size="2" face="Arial">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumCode = 'L'">&#xA0;<font size="2" face="Arial">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
			...
			<tr>
				<td>
					<xsl:if test="count($SumHeader3) &gt; 0 or count($KeyHeader3) &gt; 0">
						<table width="650" border="1" cellpadding="3" cellspacing="0" style="border: 1px solid #d0d0d0;">
							<tr>
								<!-- Removed and replaced with vertical text -->
								<!--<td colspan="11">
							...
							-->
								...
								<th>
									<font size="2" face="Arial">Key indicators for this party</font>
								</th>
							</tr>
							<tr>
								<td width="140" align="center">
							...
							<xsl:for-each select="../MatchDetails/com.iso_SumReasonInfo[@ClaimsParty2Ref = $MSP01Id1]">
								<tr>
									...
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumspCode = 'LT'">&#xA0;<font face="arial" size="2">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumspCode = 'SI'">&#xA0;<font face="arial" size="2">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumspCode = 'N'">&#xA0;<font face="arial" size="2">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumspCode = 'A'">&#xA0;<font face="arial" size="2">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumspCode = 'S'">&#xA0;<font face="arial" size="2">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumspCode = 'P'">&#xA0;<font face="arial" size="2">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumspCode = 'D'">&#xA0;<font face="arial" size="2">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumspCode = 'V'">&#xA0;<font face="arial" size="2">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td class="cell_border" align="center">
										<xsl:choose>
											<xsl:when test="$SumspCode = 'L'">&#xA0;<font face="arial" size="2">
													<xsl:value-of select="'X'"/></font></xsl:when>
											<xsl:otherwise>&#xA0;</xsl:otherwise>
										</xsl:choose>
									</td>
		...
		<xsl:if test="count($PagerNum) &gt; 0">
			<tr>
				<td align="left" colspan="1">&#xA0;&#xA0;
					<b>
						<font size="2" face="Arial">Pager:</font>
					</b>
				</td>
				<td align="left" colspan="1">
					<font size="2" face="Arial">
...
-->
				...
				<td align="left">&#xA0;&#xA0;
					<b>
						<font size="2" face="Arial">
							...
							<xsl:choose>
								<xsl:when test="$ChkSt = 'AB' or $ChkSt ='BC' or $ChkSt ='MB' or $ChkSt ='NB' or $ChkSt ='NF' or $ChkSt ='NS' or  $ChkSt ='PE' or $ChkSt ='ON' or $ChkSt ='QC' or $ChkSt ='SK' or $ChkSt ='NT' or $ChkSt ='YT'">SIN:</xsl:when>
								<xsl:otherwise>SSN:</xsl:otherwise>
							</xsl:choose>
						</font>
					</b>
				</td>
				<td align="left">
					<font size="2" face="Arial">
						...
						<xsl:if test="$SSNValidationCd != 'I'">
							<xsl:choose>
								<xsl:when test="count(PartyInvestigationInfo/SocialSecurityIssuancePeriod/EffectiveDt) &gt;0 and count(PartyInvestigationInfo/SocialSecurityIssuancePeriod/ExpirationDt) &gt;0">between&#xA0;<xsl:value-of select="PartyInvestigationInfo/SocialSecurityIssuancePeriod/EffectiveDt"/>&#xA0;and&#xA0;<xsl:value-of select="PartyInvestigationInfo/SocialSecurityIssuancePeriod/ExpirationDt"/></xsl:when>
								<xsl:when test="count(PartyInvestigationInfo/SocialSecurityIssuancePeriod/EffectiveDt) &gt;0">&#xA0;in&#xA0;<xsl:value-of select="PartyInvestigationInfo/SocialSecurityIssuancePeriod/EffectiveDt"/></xsl:when>
								<xsl:when test="count(PartyInvestigationInfo/SocialSecurityIssuancePeriod/ExpirationDt) &gt;0">&#xA0;in&#xA0;<xsl:value-of select="PartyInvestigationInfo/SocialSecurityIssuancePeriod/ExpirationDt"/></xsl:when>
							</xsl:choose>
							<xsl:if test="count(GeneralPartyInfo/NameInfo/TaxIdentity[TaxIdTypeCd = 'SSN']/StateProvCd) &gt;0">&#xA0;in&#xA0;<xsl:value-of select="GeneralPartyInfo/NameInfo/TaxIdentity[TaxIdTypeCd = 'SSN']/StateProvCd"/></xsl:if>
						</xsl:if>
					</font>
				</td>
			</tr>
		...
		<xsl:if test="count($DeathFName) &gt;0 or count($DeathLName) &gt;0 or count($DeathDt) &gt;0 or count($DeathCity) &gt;0 or count($DeathSt) &gt;0">
			<tr>
				...
				<td align="left" nowrap="nowrap" colspan="4">
					<font face="Arial" size="2">***  SSN of Decedent ***</font>
				</td>
			</tr>
			<xsl:if test="count($DeathFName) &gt;0 or count($DeathLName) &gt;0">
				<tr>
					...
					<td align="left" nowrap="nowrap" colspan="4">
						<font face="Arial" size="2">
							<b>Decedent Name:&#xA0;&#xA0;&#xA0;&#xA0;&#xA0;</b>
							<xsl:value-of select="$DeathFName"/>&#xA0;<xsl:value-of select="$DeathLName"/></font>
					</td>
				</tr>
			</xsl:if>
			<xsl:if test="count($DeathDt) &gt;0">
			...
			<tr>
				...
				<td align="left">
					<font size="2" face="Arial">
						...
						<xsl:number value="substring($TINNum,3,7)" format="0000001"/>
						<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/TINValidationCds/*[@code=$TINValidationCd]"/>
						<xsl:if test="count(GeneralPartyInfo/NameInfo/TaxIdentity[TaxIdTypeCd = 'TIN']/TaxIdSource) &gt;0 or count(GeneralPartyInfo/NameInfo/TaxIdentity[TaxIdTypeCd = 'TIN']/StateProvCd) &gt;0">&#xA0;in&#xA0;<xsl:value-of select="GeneralPartyInfo/NameInfo/TaxIdentity[TaxIdTypeCd = 'TIN']/TaxIdSource"/>&#xA0;in&#xA0;<xsl:value-of select="GeneralPartyInfo/NameInfo/TaxIdentity[TaxIdTypeCd = 'TIN']/StateProvCd"/></xsl:if>
					</font>
				</td>
			</tr>
		</xsl:if>
		...
		<xsl:if test="count($DriverLicNum) &gt; 0">
			<tr>
				<td align="left" colspan="1">&#xA0;&#xA0;
					<b>
						<font size="2" face="Arial">Drivers License:</font>
					</b>
				</td>
				<td align="left" colspan="1">
					<font size="2" face="Arial">
		...
		<xsl:if test="$SIUInvolved = 'Y'">
			<tr>
				<td align="left" colspan="4">
					<font size="2" face="Arial">&#xA0;&#xA0;<xsl:value-of select="'&gt;  PARTY SUBJECT TO SIU INVESTIGATION'"/></font>
				</td>
			</tr>
		</xsl:if>
		<xsl:if test="$SIUNotPaid = 'Y'">
			<tr>
				<td align="left" colspan="4">
					<font size="2" face="Arial">&#xA0;&#xA0;<xsl:value-of select="'&gt;  CLAIM OR PART OF CLAIM FOR THIS PARTY WAS NOT PAID AFTER INVESTIGATION'"/></font>
				</td>
			</tr>
		</xsl:if>
		<xsl:if test="$SIUEnforceAction = 'Y'">
			<tr>
				<td align="left" colspan="4">
					<font size="2" face="Arial">&#xA0;&#xA0;<xsl:value-of select="'&gt;  PARTY WAS SUBJECT TO AN ENFORCEMENT ACTION (CRIMINAL INDICTMENT, PROFESSIONAL DISCIPLINARY ACTION)'"/></font>
				</td>
			</tr>
		</xsl:if>
		<xsl:if test="$SIUFraudBureau = 'Y'">
			<tr>
				<td align="left" colspan="4">
					<font size="2" face="Arial">&#xA0;&#xA0;<xsl:value-of select="'&gt;  CLAIM FOR THIS PARTY MEETS CRITERIA FOR STATE FRAUD BUREAU REPORTING'"/></font>
				</td>
			</tr>
		</xsl:if>
		<xsl:if test="$SIUNICBAlert = 'Y'">
			<tr>
				<td align="left" colspan="4">
					<font size="2" face="Arial">&#xA0;&#xA0;<xsl:value-of select="'&gt;  THERE IS AN NICB ALERT ASSOCIATED WITH THIS PARTY'"/></font>
				</td>
			</tr>
		</xsl:if>
	</xsl:template>
...
-->
	<xsl:template name="Display_Casualy_Info">
		...
		<xsl:variable name="ClaimStatusCd" select="$ClaimRoot/ClaimsPayment[@idref = $MC01Id]/ClaimsPaymentCovInfo/ClaimStatusCd"/>
		...
		<xsl:call-template name="Insert_Data">
			<xsl:with-param name="Data_Name">Alleged Injury</xsl:with-param>
			<xsl:with-param name="Data_Value">
		...
		<xsl:if test="count($DeleteFromCMS) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">Delete From CMS</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:if test="$DeleteFromCMS='Y'">YES</xsl:if>
				</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
		<!--
	<xsl:call-template name="Insert_Data">
		...
		<xsl:variable name="MC01EstLoss" select="$ClaimRoot/ClaimsOccurrence/ProbableIncurredAmt[contains(@idref,$MC01Id)]/Amt"/>
		...
		<xsl:variable name="MC01ResAmt" select="$ClaimRoot/ClaimsPayment[@idref = $MC01Id][PaymentTypeCd = 'LossResv']/TotalPaymentAmt/Amt"/>
		...
		<xsl:variable name="MC01SettleAmt" select="$ClaimsPayNode/TotalPaymentAmt/Amt"/>
		<xsl:if test="count($MC01SettleAmt) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">Settlement Amount</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<!--<xsl:value-of select="$ClaimsPayNode/TotalPaymentAmt/Amt"/>-->
		...
		<xsl:if test="count($MC01LossStartDt) &gt;0">
			<tr>
				<td align="left">&#xA0;&#xA0;
					<b>
						<font size="2" face="Arial">Loss Time Start Date:</font>
					</b>
				</td>
				<td align="left">
					<font size="2" face="Arial">
		...
		<xsl:call-template name="Insert_Data">
			...
			<xsl:with-param name="Data_Value">
				<xsl:value-of select="$ClaimsInjNode[@id=$InjInfoId]/TimeLostPeriod/DurationPeriod/NumUnits"/>
			</xsl:with-param>
		</xsl:call-template>
		<!--
		<xsl:call-template name="Insert_Data">
		...
		<xsl:if test="count($MC01CourtFiled) &gt;0">
			<tr>
				<td align="left">&#xA0;&#xA0;
					<b>
						<font size="2" face="Arial">Court Filed:</font>
					</b>
				</td>
				<td align="left">
					<font size="2" face="Arial">
		...
		<xsl:if test="count($CourtCty) &gt;0 or count($CourtSt) &gt;0">
			<tr>
				<td align="left">&#xA0;&#xA0;
					<b>
						<font size="2" face="Arial">Court County/State:</font>
					</b>
				</td>
				<td align="left">
					<font size="2" face="Arial">
						<xsl:value-of select="$CourtCty"/>&#xA0;&#xA0;</font>
					<font size="2" face="Arial">
		...
		<xsl:if test="count($CMSNFLT) &gt;0 or count($CMSExDt) &gt;0">
			<tr>
				<td align="left">&#xA0;&#xA0;
					<b>
						<font size="2" face="Arial">No Fault Inurance Limit:</font>
					</b>
				</td>
				<td align="left">
					...
					<xsl:choose>
						<xsl:when test="$CMSNFLT mod 100 = 0">
							<font size="2" face="Arial">
								<xsl:value-of select='format-number($NoFlt, "$###,###,###.##")'/>.00</font>
						</xsl:when>
						<xsl:otherwise>
							<font size="2" face="Arial">
		...
		<xsl:if test="count($CMSORMInd) &gt;0 or count($CMSORMDt) &gt;0">
			<tr>
				<tr>
					<td align="left" nowrap="nowrap">&#xA0;&#xA0;
						<b>
							<font size="2" face="Arial">On-Going Responsibility</font>
						</b>
					</td>
				</tr>
				<tr>
					<td align="left" nowrap="nowrap">&#xA0;&#xA0;
						<b>
							<font size="2" face="Arial">for Medicals(ORM):</font>
						</b>
					</td>
					<td align="left" nowrap="nowrap">
						<font size="2" face="Arial">
			...
			<xsl:for-each select="$CMSTPOC/com.iso_TPOCDt">
				...
				<xsl:if test="string-length(normalize-space($CMSTPOC/com.iso_TPOCDt[@id=$TPOCid])) &gt;0">
					<tr>
						<td align="left" nowrap="nowrap">
							<b>
								<font size="2" face="Arial">
									<xsl:value-of select="$TPOCid"/>.&#xA0;Total Payment Obligation to</font>
							</b>
						</td>
					</tr>
				</xsl:if>
				<tr>
					<xsl:if test="string-length(normalize-space($CMSTPOC/com.iso_TPOCDt[@id=$TPOCid])) &gt;0">
						<td align="left" nowrap="nowrap">&#xA0;&#xA0;&#xA0;
							<b>
								<font size="2" face="Arial">the Claimant(TPOC) Date:</font>
							</b>
						</td>
						<td align="left">
							<font size="2" face="Arial">
...
TPOC Amount:</font>
								...
								<xsl:choose>
									<xsl:when test="$TPOCAmt mod 100 = 0">
										<font size="2" face="Arial">
											<xsl:value-of select='format-number($TPOCAmt, "$###,###,###.##")'/>.00</font>
									</xsl:when>
									<xsl:otherwise>
										<font size="2" face="Arial">
					...
					<xsl:if test="string-length(normalize-space($CMSTPOC/com.iso_TPOCStartDt[@id=$TPOCid])) &gt;0">
						<tr>
							<td align="left">&#xA0;&#xA0;&#xA0;
								<b>
									<font size="2" face="Arial">Funding Delayed Beyond</font>
								</b>
							</td>
						</tr>
					</xsl:if>
					<xsl:if test="string-length(normalize-space($CMSTPOC/com.iso_TPOCStartDt[@id=$TPOCid])) &gt;0">
						<tr>
							<td align="left">&#xA0;&#xA0;&#xA0;
								<b>
									<font size="2" face="Arial">TPOC Start Date:</font>
								</b>
							</td>
							<td align="left">
								<font size="2" face="Arial">
...
-->
	<xsl:template name="Display_Property">
				...
				<td align="left" nowrap="nowrap" colspan="5">
					<table border="1" cellspacing="1" cellpadding="1" width="500">
						...
						<tr>
							...
							<td align="center" nowrap="nowrap">
								<xsl:choose>
									<xsl:when test="string-length($PropLossNode/ClaimsSubjectInsuranceInfo[SubjectInsuranceCd =   'STOCK']/ProbableIncurredAmt/Amt) = 0">
										<xsl:value-of select="'--'"/>
									</xsl:when>
									<xsl:otherwise>
										<font face="Arial" size="2">
											<xsl:variable name="LossStckAmt" select="$PropLossNode/ClaimsSubjectInsuranceInfo  [SubjectInsuranceCd = 'STOCK']/ProbableIncurredAmt/Amt"/>
						...
						<tr>
							...
							<td align="center" nowrap="nowrap">
								<xsl:choose>
									<xsl:when test="string-length($PropLossNode/ClaimsSubjectInsuranceInfo[SubjectInsuranceCd =   'STOCK']/ClaimsPayment[PaymentTypeCd = 'LossResv']/ClaimsPaymentCovInfo/PaymentAmt/Amt) = 0">
										<xsl:value-of select="'--'"/>
									</xsl:when>
									<xsl:otherwise>
										<font face="Arial" size="2">
											<xsl:variable name="ResStckAmt" select="$PropLossNode/ClaimsSubjectInsuranceInfo  [SubjectInsuranceCd = 'STOCK']/ClaimsPayment[PaymentTypeCd = 'LossResv']/ClaimsPaymentCovInfo/PaymentAmt/Amt"/>
						...
						<tr>
							...
							<td align="center" nowrap="nowrap">
								<xsl:choose>
									<xsl:when test="string-length($PropLossNode/ClaimsSubjectInsuranceInfo[SubjectInsuranceCd =   'STOCK']/ClaimsPayment[PaymentTypeCd = 'Payment']/ClaimsPaymentCovInfo/PaymentAmt/Amt) = 0">
										<xsl:value-of select="'--'"/>
									</xsl:when>
									<xsl:otherwise>
										<font face="Arial" size="2">
											<xsl:variable name="PaidStckAmt" select="$PropLossNode/ClaimsSubjectInsuranceInfo  [SubjectInsuranceCd = 'STOCK']/ClaimsPayment[PaymentTypeCd = 'Payment']/ClaimsPaymentCovInfo/PaymentAmt/Amt"/>
		...
		<xsl:call-template name="Insert_Data_Using_Code_List">
			<xsl:with-param name="Data_Name">Building Type</xsl:with-param>
			<xsl:with-param name="Data_Code">
		...
		<xsl:call-template name="Insert_Data">
			...
			<xsl:with-param name="Data_Value">
				...
				<xsl:if test="$Fireincendiary=0">NO</xsl:if>
				<xsl:if test="$Fireincendiary=1">YES</xsl:if>
			</xsl:with-param>
		</xsl:call-template>
		...
		<xsl:if test="count($PropLossNode/PropertySchedule/ItemDefinition/ItemTypeCd) &gt; 0">
			<xsl:call-template name="Insert_SmallHeader">
				<xsl:with-param name="Data_Name">Property Lost</xsl:with-param>
			</xsl:call-template>
		</xsl:if>
...
-->
	<xsl:template name="Display_Water_Mobile_Property">
		...
		<xsl:call-template name="Insert_Header">
			<xsl:with-param name="Data_Name">Boat &amp; Mobile Equipment Loss Information</xsl:with-param>
		</xsl:call-template>
		<xsl:variable name="CoverageType" select="$AdjusterNode/CoverageCd"/>
		<xsl:variable name="LossType" select="$AdjusterNode/LossCauseCd"/>
		<xsl:call-template name="Insert_Adjuster">
		...
		<xsl:call-template name="Insert_Data">
			...
			<xsl:with-param name="Data_Value">
				<xsl:value-of select="$PropLossNode/Watercraft/ItemDefinition[ItemTypeCd = 'Watercraft']/ModelYear"/>&#xA0;<xsl:value-of select="$PropLossNode/Watercraft/ItemDefinition[ItemTypeCd = 'Watercraft']/Manufacturer"/>&#xA0;<xsl:value-of select="$PropLossNode/Watercraft/ItemDefinition[ItemTypeCd = 'Watercraft']/Model"/></xsl:with-param>
		</xsl:call-template>
		<!--
		<xsl:call-template name="Insert_SmallHeader">
		...
		<xsl:call-template name="Insert_SmallHeader">
			<xsl:with-param name="Data_Name">Mobile/Off Road Equipment Information</xsl:with-param>
			<xsl:with-param name="Data_Value"/>
		</xsl:call-template>
		<xsl:call-template name="Insert_Data">
...
-->
	<xsl:template name="Display_Water_Mobile_Salvage">
		...
		<xsl:if test="count($MP08SalDt) &gt; 0">
			<xsl:call-template name="Insert_Header">
				<xsl:with-param name="Data_Name">Boat &amp; Mobile Equipment Salvage Information</xsl:with-param>
			</xsl:call-template>
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">VIN</xsl:with-param>
				<xsl:with-param name="Data_Value">
	...
	<xsl:template name="Display_NMVTIS_Info">
		...
		<tr>
			<td style="width:245px;">
				<font size="2" face="Arial">
					<b>&#xA0;&#xA0;&#xA0;Date Vehicle Determined to be <br></br> &#xA0;&#xA0;&#xA0;Total Loss</b>
				</font>
			</td>
			<td>
				<font size="2" face="Arial">
		...
		<tr>
			<td style="width:245px;">
				<font size="2" face="Arial">
					<b>&#xA0;&#xA0;&#xA0;Name of Owner at Designated <br></br> &#xA0;&#xA0;&#xA0;Total Loss Date</b>
				</font>
			</td>
			<td>
				<font size="2" face="Arial">
					<xsl:choose>
						<xsl:when test="string-length(./com.iso_TotalLossName/NameInfo/PersonName) != 0">
							...
							<xsl:if test="string-length(./com.iso_TotalLossName/NameInfo/PersonName/OtherGivenName) != 0 ">&#xA0;<xsl:value-of select="./com.iso_TotalLossName/NameInfo/PersonName/OtherGivenName"/></xsl:if>
							<xsl:if test="string-length(./com.iso_TotalLossName/NameInfo/PersonName/Surname) != 0 ">&#xA0;<xsl:value-of select="./com.iso_TotalLossName/NameInfo/PersonName/Surname"/></xsl:if>
						</xsl:when>
						<xsl:otherwise>
		...
		<tr>
			<td style="width:245px;">
				<font size="2" face="Arial">
					<b>&#xA0;&#xA0;&#xA0;Name of Owner at Time Report <br></br> &#xA0;&#xA0;&#xA0;Filed</b>
				</font>
			</td>
			<td>
				<font size="2" face="Arial">
					<xsl:choose>
						<xsl:when test="string-length(./com.iso_ReportFiledName/NameInfo/PersonName) != 0">
							...
							<xsl:if test="string-length(./com.iso_ReportFiledName/NameInfo/PersonName/OtherGivenName) != 0 ">&#xA0;<xsl:value-of select="./com.iso_ReportFiledName/NameInfo/PersonName/OtherGivenName"/></xsl:if>
							<xsl:if test="string-length(./com.iso_ReportFiledName/NameInfo/PersonName/Surname) != 0 ">&#xA0;<xsl:value-of select="./com.iso_ReportFiledName/NameInfo/PersonName/Surname"/></xsl:if>
						</xsl:when>
						<xsl:otherwise>
...
-->
	<xsl:template name="Display_Vehicle_Info">
		...
		<xsl:variable name="MV01Id" select="$VehLossNode/@id"/>
		<xsl:variable name="NewVINRec" select="$ClaimRoot/RecoveryInfo[@ItemRef = $MV01Id]/com.iso_VehRecoveryInd[@ItemRef = $MV01Id]"/>
		<!--<xsl:call-template name="Insert_Header">-->
		<xsl:call-template name="Insert_Recovery_Header">
			<xsl:with-param name="Data_Name">Vehicle Coverage Information</xsl:with-param>
			<xsl:with-param name="Data_Value">
				<xsl:if test="$NewVINRec = 'Y'">&#xA0;&#xA0;-&#xA0;&#xA0;New Recovery</xsl:if>
			</xsl:with-param>
		</xsl:call-template>
		<xsl:variable name="CoverageType" select="$AdjusterNode/CoverageCd"/>
		<xsl:variable name="LossType" select="$AdjusterNode/LossCauseCd"/>
		...
		<xsl:call-template name="Insert_Data">
			...
			<xsl:with-param name="Data_Value">
				<xsl:value-of select="$VehLossNode/VehInfo/ModelYear"/>&#xA0;<xsl:value-of select="$VehLossNode/VehInfo/Manufacturer"/>&#xA0;<xsl:value-of select="$VehLossNode/VehInfo/Model"/></xsl:with-param>
		</xsl:call-template>
		<!--
		<xsl:call-template name="Insert_Data">
		...
		<xsl:variable name="MV01SettleLoss" select="$ClaimsPayNode/TotalPaymentAmt/Amt"/>
		<xsl:if test="count($MV01SettleLoss) &gt; 0">
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">Settlement Amount</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<!--<xsl:value-of select="$ClaimsPayNode/TotalPaymentAmt/Amt"/>-->
		...
		<xsl:call-template name="Insert_Data">
			<xsl:with-param name="Data_Name">Recovery Agency City</xsl:with-param>
			<xsl:with-param name="Data_Value">
				<xsl:value-of select="$InvestigationNode/RecoveryInfo[@ItemRef = $MV01Id]/Addr/CommercialName | $ClaimRoot/RecoveryInfo[@ItemRef = $MV01Id]/Addr/City"/>
			</xsl:with-param>
		</xsl:call-template>
		<xsl:call-template name="Insert_Data">
			<xsl:with-param name="Data_Name">Recovery Location State</xsl:with-param>
		...
		<xsl:call-template name="Insert_Data">
			<xsl:with-param name="Data_Name">Product Liability</xsl:with-param>
			<xsl:with-param name="Data_Value">
				<xsl:value-of select="$ClaimRoot/com.iso_AddCovInfo/com.iso_CovInfo2[@itemRef=$MV01Id]/com.iso_ProdLiabInd"/>
			</xsl:with-param>
		</xsl:call-template>-->
			...
			<xsl:for-each select="$CMSTPOC/com.iso_TPOCDt">
				...
				<xsl:if test="string-length(normalize-space($CMSTPOC/com.iso_TPOCDt[@id=$TPOCid])) &gt;0">
					<tr>
						<td align="left">
							<b>
								<font size="2" face="Arial">
									<xsl:value-of select="$TPOCid"/>.&#xA0;Total Payment Obligation</font>
							</b>
						</td>
					</tr>
				</xsl:if>
				<tr>
					<xsl:if test="string-length(normalize-space($CMSTPOC/com.iso_TPOCDt[@id=$TPOCid])) &gt;0">
						<td align="left">&#xA0;&#xA0;&#xA0;
							<b>
								<font size="2" face="Arial">to the Claimant(TPOC) Date:</font>
							</b>
						</td>
						<td align="left">
							<font size="2" face="Arial">
					...
					<xsl:if test="string-length(normalize-space($CMSTPOC/com.iso_TPOCAmt[@id=$TPOCid])) &gt;0">
						<td nowrap="nowrap">
							<b>
								<font size="2" face="Arial">TPOC Amount:</font>
							</b>
							<xsl:variable name="TPOCAmt" select="$CMSTPOC/com.iso_TPOCAmt[@id=$TPOCid] div 100"/>
							<xsl:choose>
								<xsl:when test="$TPOCAmt mod 100 = 0">
		...
		<xsl:if test="string-length(normalize-space($InvestigationNode/RecoveryInfo/com.iso_TheftVerification)) &gt; 0 ">
			...
			<xsl:variable name="MiscText" select="$ClaimRoot/RemarkText[@ItemRef = $MV14Misc]"/>
			...
			<xsl:choose>
				<xsl:when test="count($MV14PoliceDt) &gt; 0">
					<xsl:call-template name="Insert_MV14_Data">
						...
						<xsl:with-param name="Data_Value">Records indicate that on
							...
							<xsl:value-of select="$MV14PoliceAgency"/>&#xA0;&#xA0;&#xA0;police department received a vehicle theft report for VIN:
							<xsl:value-of select="$VehLossNode/VehInfo/VehIdentificationNumber"/>&#xA0;&#xA0;&#xA0;and has assigned to it case number <xsl:value-of select="$MV14OCA"/>.</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
		...
		<xsl:if test="string-length(normalize-space($ClaimRoot/InvestigationInfo/AutoInvestigationInfo/ShippedConditionDesc)) &gt; 0 or string-length(normalize-space($ClaimRoot/InvestigationInfo/AutoInvestigationInfo/EventInfo[EventCd = 'Shipping']/EventDt)) &gt; 0 ">
			...
			<xsl:if test="count($VehYear) &gt; 0 or count($VehMake) &gt; 0 or count($VehModel) &gt; 0">
				<xsl:call-template name="Insert_Data">
					<xsl:with-param name="Data_Name">Vehicle</xsl:with-param>
					<xsl:with-param name="Data_Value">
						<xsl:value-of select="$VehYear"/>&#xA0;<xsl:value-of select="$VehMake"/>&#xA0;<xsl:value-of select="$VehModel"/></xsl:with-param>
				</xsl:call-template>
			</xsl:if>
			<!--
...
-->
	<xsl:template name="Display_Vehicle_Add_Recovery">
		...
		<xsl:variable name="RecLoc" select="string-length(InvestigationInfo/RecoveryInfo/RecoveryLocDesc)"/>
		<xsl:variable name="VehRef" select="string-length(InvestigationInfo/RecoveryInfo/com.iso_RecoveryVehNumber)"/>
		<xsl:variable name="RecTxt" select="string-length(InvestigationInfo/RecoveryInfo/CannedRecoveryCd)"/>
		...
		<xsl:if test="($RecLoc &gt; 0) or ($VehRef &gt; 0) or ($RecTxt &gt; 0) or ($RecLoc1 &gt; 0) or ($VehRef1 &gt; 0) or ($RecTxt1 &gt; 0) ">
			...
			<xsl:call-template name="Insert_Data">
				...
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="$ClaimRoot/RecoveryInfo[@ItemRef = $InvId]/RecoveryLocDesc"/>
				</xsl:with-param>
			</xsl:call-template>
			<!--
			<xsl:call-template name="Insert_Data">
...
-->
	<xsl:template name="Display_Vehicle_Salvage">
		...
		-->
			...
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">Owner Retaining Salvage Indicator</xsl:with-param>
				<xsl:with-param name="Data_Value">
			...
			<xsl:choose>
				<xsl:when test="string-length(normalize-space($BuyerNode/GeneralPartyInfo/NameInfo/PersonName)) &gt; 0">
					<xsl:call-template name="Insert_Data">
						...
						<xsl:with-param name="Data_Value">
							<xsl:value-of select="$BuyerNode/GeneralPartyInfo/NameInfo/PersonName/GivenName"/>
							<xsl:if test="string-length($BuyerNode/GeneralPartyInfo/NameInfo/PersonName/OtherGivenName) != 0 ">&#xA0;<xsl:value-of select="$BuyerNode/GeneralPartyInfo/NameInfo/PersonName/OtherGivenName"/></xsl:if>
							<xsl:if test="string-length($BuyerNode/GeneralPartyInfo/NameInfo/PersonName/Surname) != 0 ">&#xA0;<xsl:value-of select="$BuyerNode/GeneralPartyInfo/NameInfo/PersonName/Surname"/></xsl:if>
						</xsl:with-param>
					</xsl:call-template>
					<!--
					<xsl:call-template name="Insert_Data">
			...
			<xsl:call-template name="Insert_Data">
				<xsl:with-param name="Data_Name">Product Liability</xsl:with-param>
				<xsl:with-param name="Data_Value">
					<xsl:value-of select="$ClaimRoot/com.iso_AddCovInfo/com.iso_CovInfo2[@itemRef=$MV08Id1]/com.iso_ProdLiabInd"/>
				</xsl:with-param>
			</xsl:call-template>
			-->
																			...
																			<TD align="center">
																				<B>
																					<font size="2" face="Arial">
																						...
																						<xsl:if test="$RuleWeight != '0'">+<xsl:value-of select="$RuleWeight"/></xsl:if>
													...
													<TABLE border="0" cellpadding="0" cellspacing="0" width="670" align="right">
																	...
																	<b>
																		...
																		<xsl:choose>
																			<xsl:when test="count($PartyName) &gt; 0">
																				<xsl:value-of select="GeneralPartyInfo/NameInfo/PersonName/GivenName"/>
																				<xsl:if test="count(GeneralPartyInfo/NameInfo/PersonName/OtherGivenName) &gt; 0 ">&#xA0;<xsl:value-of select="GeneralPartyInfo/NameInfo/PersonName/OtherGivenName"/></xsl:if>
																				<xsl:if test="count(GeneralPartyInfo/NameInfo/PersonName/Surname) &gt; 0 ">&#xA0;<xsl:value-of select="GeneralPartyInfo/NameInfo/PersonName/Surname"/> :</xsl:if>
																			</xsl:when>
																			<xsl:otherwise>
																				<xsl:value-of select="GeneralPartyInfo/NameInfo/CommlName/CommercialName"/>:</xsl:otherwise>
																		</xsl:choose>
																	</b>
														...
														<TR>
															<TD align="left" bgcolor="#EAE6DF">&#xA0;
																<font size="3" face="Arial">Involved Party Rules :</font>
																						...
																						<xsl:otherwise>
																							<tr valign="bottom">
																								<TD colspan="3" valign="middle">
																									<li>
																										<font size="2" face="Arial">No involved party rules apply</font>
																									</li>
																								</TD>
																							</tr>
																						</xsl:otherwise>
																								...
																								<TD align="center">
																									<B>
																										<font size="2" face="Arial">
																											...
																											<xsl:if test="$InWeight != '0'">+<xsl:value-of select="$InWeight"/></xsl:if>
																					...
																					<td width="270">
																						...
																						<tr>
																							<td colspan="2" align="left">&#xA0;
																								<font size="3" face="Arial">Matching Claims Score:
																							...
																							<xsl:choose>
																								<xsl:when test="sum($ClaimRoot/com.iso_ClaimsScoringInfo/com.iso_ClaimsScoreReport[@idref=$MO01Id]/NumMatches) &gt; 0">
																									<tr>
																										<td colspan="2" align="left">
																											<li>
																												<font size="2" face="Arial">Elements Searched:
																													<xsl:variable name="cnt"
																													              select="count($ClaimRoot/com.iso_ClaimsScoringInfo/com.iso_ClaimsScoreReport[@idref=$MO01Id]/com.iso_SearchableElementCd)"/>
																													<xsl:value-of select="$cnt"/>
																													<xsl:variable name="SRCH_NAME_ADDRESS">
																														<xsl:variable name="srch_name"
																														              select="$ClaimRoot/com.iso_ClaimsScoringInfo/com.iso_ClaimsScoreReport[@idref=$MO01Id]/com.iso_SearchableElementCd[.= 'NameAddress']"/>
																													...
																													<xsl:variable name="SRCH_TAX">
																														...
																														<xsl:variable name="srch_tax"
																														              select="$ClaimRoot/com.iso_ClaimsScoringInfo/com.iso_ClaimsScoreReport[@idref=$MO01Id]/com.iso_SearchableElementCd[.= 'TaxIdentity']"/>
																													...
																													<xsl:variable name="SRCH_VIN">
																														...
																														<xsl:variable name="srch_vin"
																														              select="$ClaimRoot/com.iso_ClaimsScoringInfo/com.iso_ClaimsScoreReport[@idref=$MO01Id]/com.iso_SearchableElementCd[.= 'VIN']"/>
																													...
																													<xsl:variable name="SRCH_DRIVERS_LIC">
																														...
																														<xsl:variable name="srch_dr_lic"
																														              select="$ClaimRoot/com.iso_ClaimsScoringInfo/com.iso_ClaimsScoreReport[@idref=$MO01Id]/com.iso_SearchableElementCd[.= 'DriversLicense']"/>
																													...
																													<xsl:variable name="SRCH_LIC_PLATE">
																														...
																														<xsl:variable name="srch_lic_pl"
																														              select="$ClaimRoot/com.iso_ClaimsScoringInfo/com.iso_ClaimsScoreReport[@idref=$MO01Id]/com.iso_SearchableElementCd[.= 'LicensePlate']"/>
																														<!--<xsl:value-of select="$ClaimRoot/com.iso_ClaimsScoringInfo/com.iso_ClaimsScoreReport[@idref=$MO01Id]/com.iso_SearchableElementCd[.= 'NameAddress']"/>-->
																													...
																													<xsl:variable name="SRCH_PH_NUMBER">
																														...
																														<xsl:variable name="srch_phone"
																														              select="$ClaimRoot/com.iso_ClaimsScoringInfo/com.iso_ClaimsScoreReport[@idref=$MO01Id]/com.iso_SearchableElementCd[.= 'PhoneNumber']"/>
																														<!--<xsl:value-of select="$ClaimRoot/com.iso_ClaimsScoringInfo/com.iso_ClaimsScoreReport[@idref=$MO01Id]/com.iso_SearchableElementCd[.= 'NameAddress']"/>-->
																														<xsl:value-of select="$xmlCodeList/ClaimsearchCodes/SearchableElementCds/*[@code=$srch_phone]"/>
																													</xsl:variable>(<xsl:value-of select="$SRCH_NAME_ADDRESS"/>
																													...
																													<xsl:value-of select="$SRCH_PH_NUMBER"/>)</font>
																											</li>
																										</td>
																										<!--
																								...
																								<xsl:otherwise>
																									<tr>
																										<td colspan="3" align="left">
																											<li>
																												<font size="2" face="Arial">There were no contributing matching claims for this Involved Party</font>
																											</li>
																										</td>
																									</tr>
																									<tr>
