...
class CountryAddressFields {
   ...
   * of this class, CountryAddressFields, is used.
   */  
  ...
  function getContactRequiredFields(contact : Contact) : Set<AddressOwnerFieldId> {
    // Default implementation ignores country
    return contact typeis Place ? CCAddressOwnerFieldId.POSTALCODE_REQUIRED : CCAddressOwnerFieldId.NO_FIELDS
  }
  ...
  static property get DefaultCountryHasStates() : boolean {
    return forCountry(BaseAdminUtil.getDefaultCountry()).IsCountryWithStates
  }
