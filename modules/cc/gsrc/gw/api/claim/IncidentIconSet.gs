...
class IncidentIconSet {
  ...
  final public static var BAGGAGE : IncidentIconSet
          = register(BaggageIncident, "panel_icon_baggage.gif", "header_icon_baggage.png", "btn_icon_baggage.gif")
  ...
  final public static var INJURY : IncidentIconSet
          = register(InjuryIncident, "panel_icon_injury.png", "header_icon_injury.png", "btn_icon_injury.gif")
  ...
  final public static var PROPERTY_LIABILITY : IncidentIconSet
          = register(FixedPropertyIncident, "panel_icon_propertyDamage.png", "header_icon_property.png", "btn_icon_property.gif")

  /** Icons for trip incident */
  final public static var TRIP : IncidentIconSet
          = register(TripIncident, "panel_icon_travel.gif", "header_icon_trip.png", "btn_icon_travel.gif")

  /**
   * Icons for vehicle incident; vehicle incidents use different panel/header icons for first
   * and third party incidents
   */
  final public static var VEHICLE : IncidentIconSet = register(new IncidentIconSet(VehicleIncident, "panel_icon_car_1st.gif", "header_icon_vehicle_1st.png", "btn_icon_vehicle.gif") {
    override function getPanelIcon(incident : Incident) : String {
      return incident typeis VehicleIncident and incident.VehicleLossParty == LossPartyType.TC_INSURED
              ? DefaultPanelIcon : "panel_icon_car_3rd.gif"
    }
  ...
  final public static var PANEL_PEDESTRIAN_ICON : String = "panel_icon_pedestrian.gif"    
}
