...
class IncidentUIHelpers {
  ...
  public static final var DWELLING : IncidentUIHelper = new IncidentUIHelper(DwellingIncident, false) {
    override property get CreateLabel() : String {
      return displaykey.Web.CreateIncident.DwellingIncident
    }
    override property get EditLabel() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.Dwelling.EditLabel
    }
    override property get RemoveLabel() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.Dwelling.RemoveLabel
    }
    ...
    override function getInstanceDisplayName(incident : Incident) : String {
      return displaykey.Web.NewLossDetailsScreen.IncidentIterator.Dwelling.Value
    }
    ...
    override property get RemoveConfirmMsg() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.Dwelling.RemoveConfirm
    }
  }
  ...
  public static final var INJURY : IncidentUIHelper = new IncidentUIHelper(InjuryIncident, true) {
    override property get CreateLabel() : String {
      return displaykey.Web.CreateIncident.InjuryIncident
    }
    override property get EditLabel() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.Injury.EditLabel
    }
    override property get RemoveLabel() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.Injury.RemoveLabel
    }
    override property get RemoveConfirmMsg() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.Injury.RemoveConfirm
    }
    override function goToCreateIncident(claim : Claim) {
    ...
    override function getInstanceDisplayName(incident : Incident) : String {
      ...
      return (injuryIncident.injured.DisplayName.HasContent ? injuryIncident.injured.DisplayName : displaykey.Web.NewLossDetailsScreen.IncidentIterator.Injury.Injured.Value)
    }
    override function goToViewIncident(incident : Incident, inEditMode : boolean) {
  ...
  public static final var LIVING_EXPENSES : IncidentUIHelper = new IncidentUIHelper(LivingExpensesIncident, false) {
    override property get CreateLabel() : String {
      return displaykey.Web.CreateIncident.LivingExpensesIncident
    }
    override property get EditLabel() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.LivingExpenses.EditLabel
    }
    override property get RemoveLabel() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.LivingExpenses.RemoveLabel
    }
    override property get RemoveConfirmMsg() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.LivingExpenses.RemoveConfirm
    }
    override function goToCreateIncident(claim : Claim) {
      NewLivingExpensesIncidentPopup.push(claim)
    }
    override function getInstanceDisplayName(incident : Incident) : String {
      return displaykey.Web.NewLossDetailsScreen.IncidentIterator.LivingExpenses.Value
    }
    override function goToViewIncident(incident : Incident, inEditMode : boolean) {
  ...
  public static final var OTHER_STRUCTURE : IncidentUIHelper = new IncidentUIHelper(OtherStructureIncident, false) {
    override property get CreateLabel() : String {
      return displaykey.Web.CreateIncident.OtherStructuresIncident
    }
    override property get EditLabel() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.OtherStructure.EditLabel
    }
    override property get RemoveLabel() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.OtherStructure.RemoveLabel
    }
    override property get RemoveConfirmMsg() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.OtherStructure.RemoveConfirm
    }
    override function goToCreateIncident(claim : Claim) {
      NewOtherStructureIncidentPopup.push(claim)
    }
    override function getInstanceDisplayName(incident : Incident) : String {
      return displaykey.Web.NewLossDetailsScreen.IncidentIterator.OtherStructure.Other.Value
    }
    override function goToViewIncident(incident : Incident, inEditMode : boolean) {
  ...
  public static final var PROPERTY_CONTENTS : IncidentUIHelper = new IncidentUIHelper(PropertyContentsIncident, false) {
    override property get CreateLabel() : String {
      return displaykey.Web.CreateIncident.PersonalPropertyIncident
    }
    override property get EditLabel() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.PropertyContents.EditLabel
    }
    override property get RemoveLabel() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.PropertyContents.RemoveLabel
    }
    override property get RemoveConfirmMsg() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.PropertyContents.RemoveConfirm
    }
    override function goToCreateIncident(claim : Claim) {
      NewPropertyContentsIncidentPopup.push(claim)
    }
    override function getInstanceDisplayName(incident : Incident) : String {
      return displaykey.Web.NewLossDetailsScreen.IncidentIterator.PropertyContents.Property.Value
    }
    override function goToViewIncident(incident : Incident, inEditMode : boolean) {
  ...
  public static final var PROPERTY_LIABILITY : IncidentUIHelper = new IncidentUIHelper(FixedPropertyIncident, true) {
    override property get CreateLabel() : String {
      return displaykey.Web.CreateIncident.PropertyLiabilityIncident
    }
    override property get EditLabel() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.FixedProperty.EditLabel
    }
    override property get RemoveLabel() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.FixedProperty.RemoveLabel
    }
    override property get RemoveConfirmMsg() : String {
      return displaykey.Web.LossDetailsIncidentMenu.Homeowners.FixedProperty.RemoveConfirm
    }
    override function goToCreateIncident(claim : Claim) {
    ...
    override function getInstanceDisplayName(incident : Incident) : String {
      ...
      return (fixedPropertyIncident.Property.DisplayName.HasContent ? fixedPropertyIncident.Property.DisplayName : displaykey.Web.NewLossDetailsScreen.IncidentIterator.FixedProperty.Property.Value)
    }
    override function goToViewIncident(incident : Incident, inEditMode : boolean) {
      var fixedPropertyIncident = incident as FixedPropertyIncident
