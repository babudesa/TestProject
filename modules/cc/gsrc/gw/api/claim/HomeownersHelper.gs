...
abstract class HomeownersHelper {
   ...
   */
  public static final var CHECKBOX_DWELLING_ICON : String = "checkbox_dwelling.gif"

  /**
   * Checkbox icon representing other structures incidents
   */
  public static final var CHECKBOX_OTHER_STRUCTURES_ICON : String = "checkbox_otherStructures.gif"

  /**
   * Checkbox icon representing living expenses incidents
   */
  public static final var CHECKBOX_LIVING_EXPENSES_ICON : String = "checkbox_lossOfUse.gif"

  /**
   * Checkbox icon representing other proeprty contents incidents
   */
  public static final var CHECKBOX_PROPERTY_CONTENTS_ICON : String = "checkbox_contents.gif"
  ...
  static class DamageManager {
    ...
    property get Name() : String {
      return displaykey.Web.Homeowners.LossDetails[ClaimProperty.Name] as String
    }
    ...
    property set Present(newValue : boolean) {
      if (Present != newValue) {
        if (newValue) {
          var constructor = _claimProperty.Type.TypeInfo.getConstructor({})
  ...
  static function getDamages(claim : Claim) : DamageManager[] {
    return {
      new DamageManager(claim, "icon_fire.gif", "PropertyFireDamage"),
      new DamageManager(claim, "icon_water.gif", "PropertyWaterDamage")
    }
  }
