 ...
 */
enhancement GWClaimInvestigationAddRqEnhancement : xsd.iso.ClaimInvestigationAddRq {
   ...
   */
  @Autocreate
  property get PropertyLossInfo() : xsd.iso.PropertyLossInfo {
    verifyPropertyLossInfoState()
    return this.PropertyLossInfos.Count > 0 ? this.PropertyLossInfos.first() : null
  }
  
  property set PropertyLossInfo(newValue : xsd.iso.PropertyLossInfo) {
    verifyPropertyLossInfoState()
   ...
   */
  @Autocreate
  property get WorkCompLossInfo() : xsd.iso.WorkCompLossInfo {
    verifyWorkCompLossInfoState()
    return this.WorkCompLossInfos.Count > 0 ? this.WorkCompLossInfos.first() : null
  }
  
  property set WorkCompLossInfo(newValue : xsd.iso.WorkCompLossInfo) {
    verifyWorkCompLossInfoState()
