...
uses xsd.iso.ClaimsPayment
uses java.math.BigDecimal
uses xsd.iso.ClaimsPaymentCovInfo
uses xsd.iso.ItemDefinition
uses java.util.Map
uses java.util.HashMap
uses xsd.iso.RecoveryInfo
uses xsd.iso.InvestigationInfo
uses xsd.iso.StringCd
uses xsd.iso.SalvageInfo
uses xsd.iso.AdjusterPartyInfo
...
abstract class ISOLossSectionBase {
   ...
   */
  public function populate() : xsd.iso.ACORD {
   ...
   * aggregate
   */
  protected function createClaimsPayment(claimantParty : ClaimsParty) : xsd.iso.ClaimsPayment {
    var claimsPayment =  new xsd.iso.ClaimsPayment()
