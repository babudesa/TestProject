 ...
 * <p>
 * This class is an example of how you might remove dependencies on
 * specific public ids from rules. It is not intended to be used
...
class RuleGroups
{
  ...
  public static var instance : RuleGroups = new RuleGroups();
