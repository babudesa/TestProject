...
class CustomCalcs
{
  ...
  private static var calcMyTotalIncurredNet application = lib.getFinancialsCalculation( lib.getGrossTotalIncurredExpression().minus( lib.getTotalRecoveryReservesExpression() ));
