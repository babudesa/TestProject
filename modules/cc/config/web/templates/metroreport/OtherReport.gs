...
<mrb:MetroRequest xmlns:mrb="http://www.metroreporting.com">
  ...
  <mrb:Order>
		<mrb:RequestType>O</mrb:RequestType>
    <mrb:ForceDup><%=metroReport.ForceDuplicate?"Yes":"No"%></mrb:ForceDup>
    <mrb:DescriptionOther><%=translator.getSubString(claim.Description, 0, 60)%></mrb:DescriptionOther>
    ...
    <mrb:GLB>4</mrb:GLB>
      ...
      <mrb:Description1><%=translator.getSubString(metroReport.LossDescription, 0, 50)%></mrb:Description1>
      <mrb:Description2><%=translator.getSubString(metroReport.LossDescription, 50, 100)%></mrb:Description2>
      <mrb:Description3><%=translator.getSubString(metroReport.LossDescription, 100, 150)%></mrb:Description3>
      <mrb:Description4><%=translator.getSubString(metroReport.LossDescription, 150, 200)%></mrb:Description4>
    </mrb:Loss>
		<mrb:Insured>
