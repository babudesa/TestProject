...
enhancement CoreStringEnhancement : java.lang.String  //## todo: should this enhance CharSequence instead?
{  
  ...
  {
    //## todo: should this trim()? i.e., should a string with only whitespace be considered non-empty?
  ...
  /**
   * Returns this string compiled to a 
   */
