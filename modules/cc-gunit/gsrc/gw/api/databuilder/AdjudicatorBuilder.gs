...
class AdjudicatorBuilder extends PersonBuilderBase<Adjudicator, AdjudicatorBuilder>
{
  construct()
  {
    super(entity.Adjudicator, 0)
  }
   ...
   */
  public function withPrimaryAddressSetEarly(address : Address) : AdjudicatorBuilder {
   ...
   * @return the modified builder
   */
  public function withPrimaryAddressSetEarly(address : ValueGenerator<? extends Address>) : AdjudicatorBuilder {
