  ...
  override function testSampleData(bundle : Bundle) {
    {
      ...
      var contactTrucking2000 = new gw.api.databuilder.CompanyBuilder()
        .withPublicId("trucking:2000")
        .withPrimaryPhone("work")
        .withPrimaryAddressSetEarly( new gw.api.databuilder.AddressBuilder()
          .withCounty("Cleveland")
          .withAddressLine1("3150 Old School Rd.")
      ...
      var claim = new gw.api.databuilder.ClaimBuilder()
        ...
        .withPolicy( new gw.api.databuilder.PolicyBuilder()
          ...
          .withRiskUnit( new gw.api.databuilder.VehicleRUBuilder()
            ...
            .withCoverage( new gw.api.databuilder.VehicleCoverageBuilder()
              ...
              .withType("GL")
              .withDeductible(1000)))
          .withContactInRole(contactTrucking2000, "insured")
        ...
        .withContactInRole(contactTrucking1002, "maincontact")
        .withContactInRole(contactTrucking1002, "reporter")
      ...
      var exposureTrucking106 = new gw.api.databuilder.ExposureBuilder()
        ...
        .withIncident( new gw.api.databuilder.VehicleIncidentBuilder()
          ...
          .withContactInRole(contactTrucking1004, "driver"))
        .withContactInRole(contactTrucking1004, "claimant")
        .create(bundle)
    }
...

    {
      ...
      var contactTrucking2001 = new gw.api.databuilder.CompanyBuilder()
        .withPublicId("trucking:2001")
        .withPrimaryPhone("work")
        .withPrimaryAddressSetEarly( new gw.api.databuilder.AddressBuilder()
          .withCounty("Cleveland")
          .withAddressLine1("3150 Old School Rd.")
      ...
      var claim = new gw.api.databuilder.ClaimBuilder()
        ...
        .withPolicy( new gw.api.databuilder.PolicyBuilder()
          ...
          .withRiskUnit( new gw.api.databuilder.VehicleRUBuilder()
            ...
            .withCoverage( new gw.api.databuilder.VehicleCoverageBuilder()
              ...
              .withType("GL")
              .withDeductible(1000)))
          .withContactInRole(contactTrucking2001, "insured")
          .withContactInRole(contactDemoSample10196, "agent")
        ...
        .withState("open")
        .withAssignedUser(findUserByUserName("wgompers"))
        .withContactInRole(contactTrucking1003, "maincontact")
        .withContactInRole(contactTrucking1003, "reporter")
        .withNote( new gw.api.databuilder.NoteBuilder()
          .withTopic("general")
      ...
      var exposureTrucking108 = new gw.api.databuilder.ExposureBuilder()
        ...
        .withIncident( new gw.api.databuilder.VehicleIncidentBuilder()
          .withSpeed(30)
          .withVehicleUseReason("business")
          .withSeverity("minor")
          .withCollisionPoint("rightside")
          .withDriverRelation("employee")
          ...
          .withVehicle(new gw.api.databuilder.VehicleBuilder()
            ...
            .withVin("4V1WDBJF8LN623310"))
          .withOwnersPermission(true)
          .withVehicleDirection("turningright")
          .withContactInRole(contactTrucking1001, "driver"))
        .withContactInRole(contactTrucking2001, "claimant")
        .create(bundle)
    }
    {
      ...
      var claim = new gw.api.databuilder.ClaimBuilder()
        ...
        .withPolicy( new gw.api.databuilder.PolicyBuilder()
          ...
          .withRiskUnit( new gw.api.databuilder.VehicleRUBuilder()
            ...
            .withCoverage( new gw.api.databuilder.VehicleCoverageBuilder()
              ...
              .withType("COLL")
              .withDeductible(1000)))
          .withContactInRole(contactDemoSample10197, "agent")
          .withContactInRole(contactTrucking106, "insured"))
        .withFault(100)
        .withAssignedGroup(findGroupByName("Eastern Auto Group"))
        .withJurisdictionState("NC")
        .withSegment("auto_low")
        ...
        .withState("open")
        .withAssignedUser(findUserByUserName("wgompers"))
        .withContactInRole(contactDemoSample2364, "reporter")
        .create(bundle)
    ...
    }
    {
      ...
      var claim = new gw.api.databuilder.ClaimBuilder()
        ...
        .withPolicy( new gw.api.databuilder.PolicyBuilder()
          ...
          .withRiskUnit( new gw.api.databuilder.VehicleRUBuilder()
            ...
            .withCoverage( new gw.api.databuilder.VehicleCoverageBuilder()
              ...
              .withType("COLL")
              .withDeductible(1000)))
          .withContactInRole(contactDemoSample30003, "insured"))
        .withFault(100)
        .withAssignedGroup(findGroupByName("Eastern Auto Group"))
        .withJurisdictionState("NC")
        .withSegment("auto_low")
        ...
        .withState("open")
        .withAssignedUser(findUserByUserName("wgompers"))
        .withContactInRole(contactDemoSample30003, "reporter")
        .create(bundle)
