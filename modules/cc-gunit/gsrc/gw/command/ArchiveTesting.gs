...
class ArchiveTesting extends BaseCommand {
  static var _numGen = new SequentialIntegerGenerator(find(c in Claim).Count + 1)
  ...
  private function innerNewClaim(publicIdPrefix : String) : Claim {
      ...
      var claim = ClaimBuilder
                     ...
                     .create(Bundle)
        Bundle.commit()
        Logger.ARCHIVING.info("created claim:  " + claim.ClaimNumber + " with publicID = " + claim.PublicID)
      	return claim
  }
