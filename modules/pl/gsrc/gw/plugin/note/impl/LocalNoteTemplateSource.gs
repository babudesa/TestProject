...
class LocalNoteTemplateSource implements InitializablePlugin, INoteTemplateSource {
  ...
  override function setParameters( params : Map<Object,Object> ) {
    ...
    _templateDir = NoteConfigUtil.getTemplateDirectory(rootDirPath, params.get(TEMPLATES_PATH) as String)
    _descriptorDir = NoteConfigUtil.getDiscriptorDirectory(rootDirPath, params.get(DESCRIPTORS_PATH) as String)
  }
