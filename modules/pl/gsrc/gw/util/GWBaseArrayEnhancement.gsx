...
enhancement GWBaseArrayEnhancement<T> : T[] {
   ...
   */
  function findFirst( condition(elt : T):Boolean ) : T {
   ...
   */
  function findAll( condition(elt : T):Boolean ) : T[] {
   ...
   */
  function findByType<Q>( t : Type<Q> ) : Q[] {
   ...
   */
  function countMatches( condition( elt : T ):Boolean ) : int {
