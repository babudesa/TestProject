...
enhancement GWBaseIteratorEnhancement<T> : java.util.Iterator<T>
{
   ...
   */
  public function partition<Q>( partitioner(elt : T):Q ) : Map< Q, List<T> >
  {
   ...
   */
  public function partitionUniquely<Q>( partitioner(elt : T):Q ) : Map<Q, T>
  {
   ...
   */
  public function findFirst( condition(elt : T):Boolean ) : T
  {
   ...
   */
  public function hasMatch( condition(elt : T):Boolean ) : boolean
  {
   ...
   */
  public function findAll( condition(elt : T):Boolean ) : List<T>
  {
